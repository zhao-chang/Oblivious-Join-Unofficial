...
public:
    ...
    virtual void resize(const uint32_t& len, const std::string& ns = "") = 0;
    ...
    virtual void insert(const char* blocks, const uint32_t& low, const uint32_t& high, const std::string& ns = "") = 0;
    virtual void insert(const std::vector<std::string>& blocks, const uint32_t& low, const uint32_t& high, const std::string& ns = "") = 0;
    ...
    virtual std::string find(const std::string& id, const std::string& ns = "") = 0;
    ...
    virtual std::string fetch(const uint32_t& id, const std::string& ns = "") = 0;
    virtual void fetch(const uint32_t& low, const uint32_t& high, char* blocks, const std::string& ns = "") = 0;
    virtual void find(const uint32_t& low, const uint32_t& high, std::vector<std::string>& blocks, const std::string& ns = "") = 0;
    virtual void find(const uint32_t& low, const uint32_t& high, char* blocks, const std::string& ns = "") = 0;
    ...
    virtual void update(const std::string& id, const std::string& data, const std::string& ns = "") = 0;
    virtual void update(const std::string* sbuffer, const uint32_t& low, const size_t& len, const std::string& ns = "") = 0;
    virtual void update(const std::vector<std::string>& blocks, const uint32_t& low, const uint32_t& high, const std::string& ns = "") = 0;
    virtual void update(const char* blocks, const uint32_t& low, const uint32_t& high, const std::string& ns = "") = 0;
    virtual void update(const std::vector< std::pair<uint32_t, std::string> > blocks, const std::string& ns = "") = 0;
    virtual void remove(const uint32_t& id, const std::string& ns = "") = 0;
    virtual void remove(const std::string& id, const std::string& ns = "") = 0;
    virtual void remove(const uint32_t& low, const uint32_t& high, const std::string& ns = "") = 0;
