...
public:
    FileSimulator(const std::string& url, const std::string& collection_name, const bool create = false);
    ...
    virtual void insert(const std::vector<std::string>& blocks, const uint32_t& low, const uint32_t& high, const std::string& ns = "");
    ...
    virtual std::string find(const std::string& id, const std::string& ns = "");
    ...
    virtual void update(const std::string& id, const std::string& data, const std::string& ns = "");
    virtual void update(const std::string* sbuffer, const uint32_t& low, const size_t& len, const std::string& ns = "");
    virtual void update(const std::vector<std::string>& blocks, const uint32_t& low, const uint32_t& high, const std::string& ns = "");
