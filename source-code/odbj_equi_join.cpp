...
int main(int argc, char* argv[]) {
    if (argc != 5) {
        printf("Usage: ./odbj_equi_join <sort_type> <mode> <scale> <query_file>\n");
        return -1;
    }
    ...
    odbj->ObliEquiJoin(sort_type, n_tables, table_id, parent_id, attr_id, parent_attr_id, n_proj_cols, proj_id);
