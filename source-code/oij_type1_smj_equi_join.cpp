...
int main(int argc, char* argv[]) {
    if (argc != 5) {
        printf("Usage: ./oij_type1_smj_equi_join <mode> <scale> <outsourced_height> <query_file>\n");
        return -1;
    }
    ...
    oij->ObliSMEJ(n_tables, table_id, parent_id, attr_id, parent_attr_id, n_proj_cols, proj_id);
