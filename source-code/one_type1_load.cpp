...
int main(int argc, char* argv[]) {
    if (argc != 4) {
        printf("Usage: ./one_type1_load <mode> <scale> <outsourced_height>\n");
        return -1;
    }
    ...
    OneORAMIndexJoin <PathORAM>* oij = new OneORAMIndexJoin <PathORAM> (mode, scale, outsourced_height, dst, meta_prefix);
