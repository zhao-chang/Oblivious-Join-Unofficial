...
int main(int argc, char* argv[]) {
    if (argc != 5) {
        printf("Usage: ./oij_type1_smj_band_join <mode> <scale> <outsourced_height> <query_file>\n");
        return -1;
    }
    ...
    ObliIndexJoin <PathORAM>* oij = new ObliIndexJoin <PathORAM> (mode, meta_prefix);
    ...
    oij->ObliSMBJ(n_tables, table_id, parent_id, attr_id, parent_attr_id, band_range, n_proj_cols, proj_id);
