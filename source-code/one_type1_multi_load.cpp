...
int main(int argc, char* argv[]) {
    if (argc != 4) {
        printf("Usage: ./one_type1_multi_load <mode> <scale> <outsourced_height>\n");
        return -1;
    }
    ...
    OneORAMMultiwayJoin <PathORAM>* oij = new OneORAMMultiwayJoin <PathORAM> (mode, scale, outsourced_height, dst, meta_prefix);
