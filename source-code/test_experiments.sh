...
# sort_type = batcher (oblivious sort = batcher sort)
# sort_type = heap (oblivious sort = oblivious heap sort)
...
scripts/run_odbj_load.sh 1 0.05x |  tee results/tpch_0.05x_odbj_load.txt
...
scripts/run_odbj_load.sh 2 20k |  tee results/twitter_20k_odbj_load.txt
...
scripts/run_odbj_equi_join.sh localhost batcher 1 0.05x queries/tpch_binary_equi_q2.txt | tee results/tpch_0.05x_binary_equi_odbj_batcher_q2.txt
scripts/run_odbj_equi_join.sh localhost heap 1 0.05x queries/tpch_binary_equi_q2.txt | tee results/tpch_0.05x_binary_equi_odbj_heap_q2.txt

scripts/run_oij_type1_inlj_equi_join.sh localhost 1 0.05x 100 queries/tpch_binary_equi_q2.txt | tee results/tpch_0.05x_equi_oij_type1_inlj_join_100_q2.txt
scripts/run_oij_type1_inlj_equi_join.sh localhost 1 0.05x 1 queries/tpch_binary_equi_q2.txt | tee results/tpch_0.05x_equi_oij_type1_inlj_join_1_q2.txt
...
scripts/run_one_type1_inlj_equi_join.sh localhost 1 0.05x 100 queries/tpch_binary_equi_q2.txt | tee results/tpch_0.05x_equi_one_type1_inlj_join_100_q2.txt
scripts/run_one_type1_inlj_equi_join.sh localhost 1 0.05x 1 queries/tpch_binary_equi_q2.txt | tee results/tpch_0.05x_equi_one_type1_inlj_join_1_q2.txt
...
scripts/run_odbj_equi_join.sh localhost batcher 2 20k queries/twitter_binary_equi_q2.txt | tee results/twitter_20k_binary_equi_odbj_batcher_q2.txt
scripts/run_odbj_equi_join.sh localhost heap 2 20k queries/twitter_binary_equi_q2.txt | tee results/twitter_20k_binary_equi_odbj_heap_q2.txt

scripts/run_oij_type1_inlj_equi_join.sh localhost 2 20k 100 queries/twitter_binary_equi_q2.txt | tee results/twitter_20k_equi_oij_type1_inlj_join_100_q2.txt
scripts/run_oij_type1_inlj_equi_join.sh localhost 2 20k 1 queries/twitter_binary_equi_q2.txt | tee results/twitter_20k_equi_oij_type1_inlj_join_1_q2.txt
...
scripts/run_one_type1_inlj_equi_join.sh localhost 2 20k 100 queries/twitter_binary_equi_q2.txt | tee results/twitter_20k_equi_one_type1_inlj_join_100_q2.txt
scripts/run_one_type1_inlj_equi_join.sh localhost 2 20k 1 queries/twitter_binary_equi_q2.txt | tee results/twitter_20k_equi_one_type1_inlj_join_1_q2.txt
...
scripts/run_odbj_band_join.sh localhost batcher 1 0.05x queries/tpch_band_q1.txt | tee results/tpch_0.05x_band_odbj_batcher_q1.txt
scripts/run_odbj_band_join.sh localhost heap 1 0.05x queries/tpch_band_q1.txt | tee results/tpch_0.05x_band_odbj_heap_q1.txt
