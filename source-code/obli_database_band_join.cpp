...
int main(int argc, char* argv[]) {
    if (argc != 4) {
        printf("Usage: ./obli_database_band_join <mode> <scale> <query_file>\n");
        return -1;
    }
    ...
    odbj->ObliBandJoin(n_tables, table_id, parent_id, attr_id, parent_attr_id, band_range, n_proj_cols, proj_id);
